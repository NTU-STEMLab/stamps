...
def mlecovfitv(ch, zh, covmodel, covparam):
    ...
    :func:`~stamps.stamps.general.bobyqa.bobyqa`).
    ...
    **Datetime handling** — if the last column of ``ch`` contains
    ...
    --------
    >>> import numpy as np
    >>> from stamps.stamps.stats.dependence.mlecovfit import mlecovfitv
...
def mlecovfitg(grid_s, grid_t, grid_v, covmodel, covparam0):
    ...
    to ``(nt, 1)`` before calling :func:`~stamps.stamps.general.coord2K.coord2K`.
...
def mlecovfit_sub(ch, zh, covmodel, covparam0):
    ...
    --------
    >>> import numpy as np
    >>> from stamps.stamps.stats.dependence.mlecovfit import mlecovfit_sub
