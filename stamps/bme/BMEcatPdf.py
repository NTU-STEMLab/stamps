# -*- coding: utf-8 -*-
"""
Backward-compatibility shim for ``stamps.bme.BMEcatPdf``.

All public symbols have moved to :mod:`stamps.categorical`.
This module re-exports them so that existing ``from stamps.bme.BMEcatPdf import …``
