...
def get_model(m_name):
    ...
    Examples
    --------
    >>> from stamps.models.covmodel import get_model
...
def gaussianC(dist, sill, ar, jac=False, jacpar=None):
    ...
    --------
    >>> import numpy as np
    >>> from stamps.models.covmodel import gaussianC
    >>> dist = np.array([[0., 300., 600.]])
...
def sphericalC(dist, sill, ar, jac=False, jacpar=None):
    ...
    --------
    >>> import numpy as np
    >>> from stamps.models.covmodel import sphericalC
...
def holecosC(dist, a_half, p_half):
    ...
    --------
    >>> import numpy as np
    >>> from stamps.models.covmodel import holecosC
    >>> dist = np.array([[0., 500., 1000., 1500.]])
...
def nuggetC(dist, sill, ar=None, jac=False, jacpar=None):
    ...
    * both.
    ...
    --------
    >>> import numpy as np
    >>> from stamps.models.covmodel import nuggetC
...
def maternC(dist, sill, parms):
    ...
    --------
    >>> import numpy as np
    >>> from stamps.models.covmodel import maternC
    >>> dist = np.array([[0., 500., 1000.]])
